...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 62.0, 37.0, 22.0 ],
					"text" : "down"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 62.0, 29.5, 22.0 ],
					"text" : "up"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 62.0, 29.5, 22.0 ],
					"text" : "tap"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 132.0, 26.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 62.0, 48.0, 22.0 ],
					"text" : "hold $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 62.0, 32.0, 22.0 ],
					"text" : "right"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.0, 62.0, 29.5, 22.0 ],
					"text" : "left"
				}
...
,
					"patching_rect" : [ 57.0, 97.0, 65.0, 22.0 ],
					"text" : "p gestures"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 568.0, 175.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 568.0, 248.0, 77.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 568.0, 211.0, 73.0, 22.0 ],
					"text" : "mem.blips 9"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 696.0, 539.0, 75.0, 22.0 ],
					"text" : "s #0_fade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.0, 479.0, 181.0, 22.0 ],
					"text" : "pack 300 2 3 30 1. 50 0 0 10000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 575.0, 539.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 546.0, 87.0, 22.0 ],
					"text" : "s mem.listener"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 516.0, 61.0, 22.0 ],
					"text" : "pack 0. 4."
				}
...
,
					"patching_rect" : [ 69.0, 514.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 546.0, 86.0, 22.0 ],
					"text" : "s mem.oscOut"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 479.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 451.0, 51.0, 22.0 ],
					"text" : "pak 1 f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 551.0, 406.0, 90.0, 22.0 ],
					"text" : "scale 0. 1. 5. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 406.0, 94.0, 22.0 ],
					"text" : "scale 0. 1. -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "float", "float" ],
					"patching_rect" : [ 379.0, 371.0, 146.0, 22.0 ],
					"text" : "unpack i f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 379.0, 339.0, 146.0, 22.0 ],
					"text" : "route node"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 50.0, 251.0, 133.0, 55.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 75.0, 147.0, 24.0, 24.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-100" : [ "mc.live.gain~[20]", "memory echo", 0 ],
			...
			"obj-25::obj-39" : [ "mc.live.gain~[30]", "distortion", 0 ],
			...
			"obj-30::obj-39" : [ "mc.live.gain~[2]", "distortion", 0 ],
