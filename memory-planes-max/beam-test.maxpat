...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 29.0, 87.0, 22.0 ],
					"text" : "loadmess 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 29.0, 80.0, 22.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 607.0, 144.0, 80.0, 22.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 607.0, 108.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 607.0, 180.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 464.0, 180.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 108.0, 103.0, 22.0 ],
					"text" : "relativetoabsolute"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 144.0, 80.0, 22.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 72.0, 115.0, 22.0 ],
					"text" : "loadmess haze.json"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 607.0, 72.0, 119.0, 22.0 ],
					"text" : "loadmess beam.json"
				}
...
,
					...
					"patching_rect" : [ 607.0, 215.0, 50.5, 22.0 ],
...
,
					...
					"numoutlets" : 5,
					"outlettype" : [ "dictionary", "", "", "", "" ],
					"patching_rect" : [ 464.0, 215.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"legacy" : 1,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 607.0, 251.0, 88.0, 22.0 ],
					"text" : "prepend set_io"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 251.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 301.0, 65.0, 22.0 ],
					"text" : "beam.core"
				}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 365.333333333333314, 150.0, 44.0, 22.0 ],
									"text" : "sel 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 365.333333333333314, 115.0, 200.0, 24.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 365.333333333333314, 210.0, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 270.0, 314.0, 196.333333333333314, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 365.333333333333314, 176.0, 87.0, 22.0 ],
									"text" : "get_dmx_input"
								}
...
, 							{
								"patchline" : 								{
									"color" : [ 0.0, 0.0, 0.0, 1.0 ],
									"destination" : [ "obj-42", 0 ],
									"midpoints" : [ 374.833333333333314, 251.0, 239.0, 251.0, 239.0, 521.0, 279.5, 521.0 ],
									"source" : [ "obj-39", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"color" : [ 0.0, 0.0, 0.0, 1.0 ],
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 402.166666666666629, 240.0, 224.0, 240.0, 224.0, 598.0, 279.5, 598.0 ],
									"source" : [ "obj-39", 1 ]
								}
...
,
					"patching_rect" : [ 27.0, 256.0, 140.0, 94.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.0, 73.0, 53.0, 33.0 ],
					"text" : "pump\n0.0 - 1.0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 73.0, 53.0, 33.0 ],
					"text" : "speed \n0.0 - 1.0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.0, 73.0, 79.0, 60.0 ],
					"text" : "blades \n0.0 = down\n0.5 = forward\n1.0 = up"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 287.0, 72.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 110.0, 48.0, 22.0 ],
					"text" : "blue $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 154.0, 72.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.0, 110.0, 56.0, 22.0 ],
					"text" : "green $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 110.0, 43.0, 22.0 ],
					"text" : "red $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 180.0, 88.0, 22.0 ],
					"saved_object_attributes" : 					{
						"tag" : "haze"
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 215.0, 75.0, 22.0 ],
					"text" : "beam.output"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 11.0, 776.0, 467.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 489.0, 776.0, 467.0 ],
									"viewvisibility" : 1
								}
...
,
					"patching_rect" : [ 465.25, 29.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 163.5, 165.0, 36.5, 165.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 296.5, 165.0, 36.5, 165.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "beam.ioeditor.IOInspector.ArtNetOutput.maxpat",
				"bootpath" : "~/Documents/Max 9/Packages/Beam for Max/patchers/beam_ioeditor",
				"patcherrelativepath" : "../../../Documents/Max 9/Packages/Beam for Max/patchers/beam_ioeditor",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../Documents/Max 9/Packages/Beam for Max/patchers/beam_monitor",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../Documents/Max 9/Packages/Beam for Max/patchers/beam_patcheditor",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Desktop/memory-planes/memory-planes-max",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
