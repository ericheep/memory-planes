...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.5, 28.0, 83.0, 22.0 ],
					"text" : "r mem.startup"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 154.0, 66.0, 29.5, 22.0 ],
					"text" : "i 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.0, 28.0, 97.0, 22.0 ],
					"text" : "r mem.shutdown"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 66.0, 89.5, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 56.25, 107.0, 39.0, 22.0 ],
					"text" : "f 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.25, 155.0, 148.0, 22.0 ],
					"text" : "loadmess beam/haze.json"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 613.0, 155.0, 152.0, 22.0 ],
					"text" : "loadmess beam/beam.json"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.25, 384.0, 65.0, 22.0 ],
					"text" : "beam.core"
				}
...
,
					"patching_rect" : [ 21.0, 366.0, 140.0, 94.0 ],
					"presentation" : 1,
