...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 368.0, 42.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 135.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 47.0, 97.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 97.0, 79.0, 22.0 ],
					"text" : "random 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 193.0, 211.0, 29.5, 22.0 ],
					"text" : "f 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 250.0, 65.0, 22.0 ],
					"text" : "$1 0 0 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 193.0, 288.0, 44.0, 22.0 ],
					"text" : "line~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 120.0, 287.0, 61.0, 22.0 ],
					"text" : "sig~ 4500"
				}
...
,
					"patching_rect" : [ 47.0, 326.0, 165.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 47.0, 249.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 47.0, 287.0, 39.0, 22.0 ],
					"text" : "click~"
				}
