...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.0, 135.777777777777715, 37.0, 22.0 ],
									"text" : "down"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 218.0, 135.777777777777715, 29.5, 22.0 ],
									"text" : "up"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 179.0, 135.777777777777715, 29.5, 22.0 ],
									"text" : "tap"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 125.0, 135.777777777777715, 48.0, 22.0 ],
									"text" : "hold $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 135.777777777777715, 32.0, 22.0 ],
									"text" : "right"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 135.777777777777715, 29.5, 22.0 ],
									"text" : "left"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 751.666666666666629, 159.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 751.666666666666629, 196.0, 87.0, 22.0 ],
													"text" : "s mem.refocus"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 7,
													"outlettype" : [ "", "", "", "", "", "", "" ],
													"patching_rect" : [ 133.0, 116.0, 947.0, 22.0 ],
													"text" : "route left right hold tap up down"
												}
...
,
									"patching_rect" : [ 50.0, 170.555555555555429, 65.0, 22.0 ],
									"text" : "p gestures"
								}
...
,
					"patching_rect" : [ 930.0, 8.0, 83.0, 22.0 ],
					"text" : "p oldGestures"
				}
...
,
					"patching_rect" : [ 845.0, 287.444444444444457, 45.0, 22.0 ],
					"text" : "p stars"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.0, 518.0, 81.0, 22.0 ],
					"text" : "s mem.distort"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 565.0, 483.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 460.0, 454.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 460.0, 486.0, 49.0, 22.0 ],
					"text" : "-0.48 4."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 518.0, 87.0, 22.0 ],
					"text" : "s mem.listener"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.5, 238.0, 73.0, 22.0 ],
					"text" : "loadmess 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 647.5, 306.0, 93.0, 22.0 ],
					"text" : "s mem.distance"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.5, 273.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 845.5, 410.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 845.5, 380.0, 101.0, 22.0 ],
					"text" : "scale~ -1. 1. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 845.5, 352.0, 60.0, 22.0 ],
					"text" : "rand~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 929.5, 42.0, 84.0, 22.0 ],
					"text" : "mem.carousel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1033.0, 14.0, 221.0, 181.0 ],
					"text" : "improve touching light\ntransition to carousel\nfind a place to swtich boundary conditions\n\nred shitt / blue shift?\npart of freezing?\n\nthere was an idea to inverse it all\n\n\nend of carousel, arc length gets wider and reverb gets blurrrrrry"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 930.0, 76.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 110.0, 74.0, 22.0 ],
					"text" : "pack 0.48 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 930.0, 144.0, 77.0, 22.0 ],
					"text" : "s mem.offset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.0, 346.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.0, 418.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 649.0, 381.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 659.0, 484.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 659.0, 519.0, 140.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 845.5, 433.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.5, 468.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1104.0, 234.0, 150.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 989.0, 246.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
					"patching_rect" : [ 845.0, 246.0, 80.0, 22.0 ],
					"text" : "p perspective"
				}
...
,
					"patching_rect" : [ 845.0, 212.0, 77.0, 22.0 ],
					"text" : "p idleActions"
				}
...
,
					"patching_rect" : [ 845.0, 178.0, 104.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 245.5, 397.0, 30.0, 22.0 ],
									"text" : "* 60"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 246.5, 356.0, 43.0, 22.0 ],
									"text" : "* 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 246.0, 321.0, 29.0, 22.0 ],
									"text" : "thru"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 246.0, 277.0, 32.0, 22.0 ],
									"text" : "f 25."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 259.0, 244.0, 29.5, 22.0 ],
									"text" : "f 6."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 162.0, 52.0, 22.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 246.0, 208.0, 44.0, 22.0 ],
									"text" : "sel 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 246.0, 143.0, 69.0, 22.0 ],
									"text" : "counter 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 246.0, 108.0, 126.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 51.0, 119.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 51.0, 239.0, 65.0, 22.0 ],
									"text" : "mem.haze"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 1 ],
									"midpoints" : [ 255.0, 434.40625, 384.6875, 434.40625, 384.6875, 97.39453125, 362.5, 97.39453125 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-12", 0 ],
									"midpoints" : [ 255.5, 352.125, 256.0, 352.125 ],
									"source" : [ "obj-9", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 989.0, 285.0, 42.888888888888914, 42.888888888888914 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 989.0, 341.0, 85.0, 22.0 ],
					"text" : "s mem.startup"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 989.0, 378.0, 42.888888888888914, 42.888888888888914 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 989.0, 435.0, 99.0, 22.0 ],
					"text" : "s mem.shutdown"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 395.666666666666629, 52.0, 20.0 ],
					"text" : "present"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 193.0, 393.666666666666629, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 429.444444444444343, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 845.0, 76.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 845.0, 110.0, 61.0, 22.0 ],
					"text" : "pack 1. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.0, 144.0, 72.0, 22.0 ],
					"text" : "s mem.area"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 845.0, 42.0, 61.0, 22.0 ],
					"text" : "mem.lidar"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-25::obj-112" : [ "mc.live.gain~[7]", "reverb", 0 ],
			"obj-25::obj-13" : [ "mc.live.gain~[6]", "reverb", 0 ],
			"obj-25::obj-39" : [ "mc.live.gain~[23]", "distortion", 0 ],
			"obj-25::obj-92" : [ "mc.live.gain~[5]", "memory echo", 0 ],
			...
			"obj-49::obj-112" : [ "mc.live.gain~[17]", "reverb", 0 ],
			"obj-49::obj-13" : [ "mc.live.gain~[20]", "reverb", 0 ],
			"obj-49::obj-39" : [ "mc.live.gain~[19]", "distortion", 0 ],
			"obj-49::obj-92" : [ "mc.live.gain~[18]", "memory echo", 0 ],
